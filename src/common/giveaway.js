...
class Giveaway {
  constructor(amazonID, requirement, odds, price, productType, productImageURL, prizeCount, title, isDrawing) {
  ...
  static fromGACityObject(gaCityObject){
    let 
      ...
      isDrawing = isRandomDrawing(gaCityObject)
